...
async function getOffset(){
    const result=  await calculateOffset('https://static.geetest.com/pictures/gt/1e6ca4d3f/bg/406072e79.jpg','https://static.geetest.com/pictures/gt/1e6ca4d3f/1e6ca4d3f.jpg')
   console.log(result)
    const tracedata= generateSlideTrace(result)
