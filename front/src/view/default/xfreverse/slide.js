...
!function() {
    !function(t, e) {
		...
		//userresponse 是 function H(t, e) 生成 t：待研究  e为接口返回的challenge
		window.export_userresponse=function H(t, e) {
            var $_DAJEw = _tkts.$_Dm()[4][10];
            for (; $_DAJEw !== _tkts.$_Dm()[0][9]; ) {
                switch ($_DAJEw) {
                case _tkts.$_Dm()[0][10]:
		...
		//加密h变量，调用window.geth['"\u0024\u005f\u0046\u0045\u0045"'](I) I为数组也是加密得到
		window.geth=m
        function _(t) {
       ...
       window.geto_rp=function X(t) {
        ...
        var U = function() {
			...
			//h变量加密函数 调用方式window.getu['E[$_IAJX(269)][$_IBAQ(372)]']('16位随机字符串')
			window.getu=U
		...
		//此处导出构造l的函数  l = V['encrypt'](JSON.stringify(o),'4810e07182750e51')
		window.export_l=V.encrypt
