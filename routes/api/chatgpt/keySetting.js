...
getXfyunUnofficalList,getPoeUnofficalList,getChatGlmTokenList}=require('../../../controller/chatGpt/keySetting.js')
...
router.get("/chatglmtokenlist",(req,res)=>{
    getChatGlmTokenList(req,res)
})
